...
tags = {
    ...
    ["msgs"]   = { position = 2, layout = layout.tile.right, mwfact = 0.75, screen = 2, spawn = "/usr/bin/pidgin" },
    ["skype"]  = { layout = layout.fair, screen = 2, spawn = "/usr/bin/skype" },
    ["www"]    = { position = 3, layout = layout.max, screen = 1, spawn = vars.browser_cmd, },
    ...
    ["graph"]  = { position = 7, layout = layout.tile.left, screen = 1 },
    ["view"]   = { position = 8, layout = layout.tile, screen = 2 },
    ["edit"]   = { position = 9, layout = layout.tile.bottom, spawn = vars.veditor_cmd, screen = 1 },
    ["design"] = { layout = layout.fair, mwfact = 0.7, ncol = 2, screen = 1 },
    ["dbms"]   = { layout = layout.max, },
    ["other"]  = { position = 0, },
    ["vbox"]   = { layout = layout.max, screen = 2 },
    ["fpas"]   = { layout = layout.tile.right, nmaster = 3, mwfact = 0.8, screen = 2 },
    ["notes"]  = { },
    ["debug"]  = { screen = 2, nopopup = false },
    ["sql"]    = { screen = 2 },
}
...
rules = {
    ...
    { match = {"Gvim", "Vim", "Pida"},  tag = "edit" },
    { match = {"^libreoffice", "OpenOffice"},  tag = "libre" },
    { match = {"gimp"},  tag = "graph" },
    { match = {"Smplayer", "MPlayer", "VLC.*"},  tag = "video" },
    { match = {"luakit", "Opera", "Firefox", "Links", "IEXPLORE", ".*chrome", "Uzbl"},  tag = "www" },
    ...
    { match = {".*calc.*", "gpick", "screenruler", "Airappinstaller"},  float = true },
